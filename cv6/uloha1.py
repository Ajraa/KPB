#!/usr/bin/env python3
"""
Dešifrování monoalfabetické substituce - frekvenční analýza anglického textu.
"""
...
# Nejčastější anglické bigramy a trigramy
...
COMMON_TRIGRAMS = ["THE", "AND", "ING", "ION", "TIO", "ENT", "ERE", "HER", "ATE", "VER", "TER", "THA", "ATI", "HAT", "FOR", "NOT", "ALL", "BUT", "WAS", "ARE", "HIS", "ONE"]
...
def main():
    ...
    # 3. Ruční/poloautomatické mapování
